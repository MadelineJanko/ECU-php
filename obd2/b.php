...
<div class="sidebar">
    ...
    <div class="content">
        <div class="informacion">
            <p></p>&nbsp
        <h1>B = Body (Cuerpo), Significa que la falla se encuentra en la carrocería del vehículo.</h1><br/>
      ...
      <button type="submit" style="margin-right:25px;" class="btn btn-info">C = Chasis</button>
        ...
        <form action="b.php" method="POST" autocomplete="off">
      ...
      <table class="table table-bordered table-dark">
        ...
        <tbody>
          ...
          include 'buscar_b.php';

          while($row = mysqli_fetch_array($sql_query)) {
          ?>
          <tr>
          <td>
                <b><a style="text-decoration: none; color: blue;" href="b_descripcion.php?id=<?php echo $row['id']; ?>"><?= $row['codigo']?></a></b> 
            </td>
