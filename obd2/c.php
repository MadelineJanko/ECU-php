...
<div class="sidebar">
    ...
    <div class="content">
        <div class="informacion">
            <p></p>&nbsp
        <h1>C = Chasis, La falla se localiza en el chasis, tales como bolsas de aire, frenos, etc.</h1><br/>
      ...
      <button type="submit" style="margin-right:25px;" class="btn btn-info">C = Chasis</button>
        ...
        <form action="c.php" method="POST" autocomplete="off">
      ...
      <table class="table table-bordered table-dark">
        ...
        <tbody>
          <?php
          include 'buscar_c.php';

          while($row = mysqli_fetch_array($sql_query)) {
          ?>
          <tr>
          <td>
                <b><a style="text-decoration: none; color: blue;" href="c_descripcion.php?id=<?php echo $row['id']; ?>"><?= $row['codigo']?></a></b> 
            </td>
